package com.sprocomm.com.mqtttest.alipay;
...
public class Alipay {
    ...
    public Alipay(DepositFragment context, String params, AlipayResultCallBack callback) {
        mParams = params;
        mCallback = callback;
        mPayTask = new PayTask((Activity)context.getActivity());
    }
